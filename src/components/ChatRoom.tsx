...
// 生成消息id
const generateMsgId = () => String(new Date().getTime()) + Math.floor(Math.random() * 899 + 100);
        ...
        <div className="chat-room">
            <div className="welcome">
                <div className="room-action">
                    <div className="room-name">Game的聊天室 | {props.username}</div>
